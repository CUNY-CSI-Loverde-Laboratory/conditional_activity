...
We welcome all contributions to Conditional_Activity!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/augustineonyema/conditional_activity/issues)
...
The second two options both involve making a [pull request](https://github.com/augustineonyema/conditional_activity/pulls) .
