...
import conditional_activity  # noqa



# -- Project information -----------------------------------------------------

project = "Conditional_Activity"
copyright = (
    "2025, Augustine Onyema. "
...
htmlhelp_basename = "conditional_activitydoc"
...
latex_documents = [
    (master_doc, "conditional_activity.tex", "Conditional_Activity Documentation",
     "conditional_activity", "manual"),
]
