...
The Conditional_Activity *Code of Conduct* sets the rules for the behavior of
every member in the Conditional_Activity community so that everyone can
...
Conditional_Activity is part of an engaged and respectful community made up of people from all
...
avoid, you will help us make Conditional_Activity a welcoming and productive community.
...
7. **When we disagree, try to understand why**. Disagreements, both social and
   technical, happen all the time and Conditional_Activity is no exception. It is important
   that we resolve disagreements and differing views constructively. Remember
   that we’re different. The strength of Conditional_Activity comes from its varied community
...
modified by Conditional_Activity.
